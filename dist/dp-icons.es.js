import { openBlock, createBlock, resolveDynamicComponent, defineComponent, createVNode, mergeProps } from "vue";
class Library {
  constructor() {
    this.store = {};
  }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock(resolveDynamicComponent($options.getIcon), { size: $props.size }, null, 8, ["size"]);
}
...
const ArrowLeft = defineComponent({
  name: "arrow-left",
  setup(props, {
    attrs
  }) {
...
const BookAddress1 = defineComponent({
  name: "book-address-1",
  setup(props, {
    attrs
  }) {
...
const CircleCheckmark = defineComponent({
...
const Coupon = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode("svg", mergeProps({
      ...
      "fill": "none",
      "xmlns": "http://www.w3.org/2000/svg"
    }, properties), [createVNode("g", null, [createVNode("path", {
...
const DeliveryTruckClock = defineComponent({
...
const Delivery = defineComponent({
  name: "delivery",
  setup(props, {
    attrs
  }) {
...
const Discount = defineComponent({
  name: "discount",
  setup(props, {
    attrs
  }) {
...
const DoubleCheckmark = defineComponent({
...
const Employees = defineComponent({
  name: "employees",
  setup(props, {
    attrs
  }) {
...
const Employes = defineComponent({
  name: "employes",
  setup(props, {
    attrs
  }) {
...
const EyeClose = defineComponent({
  name: "eye-close",
  setup(props, {
    attrs
  }) {
...
const GiftBox = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode("svg", mergeProps({
      ...
      "d": "M13 12c0 .13281.05078.26172.14453.35547S13.3672 12.5 13.5 12.5H22c.46484 0 .91016-.1836 1.23828-.51172.32813-.32812.51172-.77344.51172-1.23828v-2c0-.46484-.1836-.91016-.51172-1.23828C22.91016 7.18359 22.46484 7 22 7h-8.5c-.13281 0-.26172.05078-.35547.14453S13 7.3672 13 7.5ZM3.75 12.5H11c.13281 0 .26172-.05078.35547-.14453S11.5 12.1328 11.5 12V7.5c0-.13281-.05078-.26172-.14453-.35547S11.1328 7 11 7H2c-.46484 0-.91016.1836-1.23828.51172C.43359 7.83984.25 8.28516.25 8.75v2c0 .46484.1836.91016.51172 1.23828C1.08984 12.31641 1.53516 12.5 2 12.5ZM11.5 14.5c0-.13281-.05078-.26172-.14453-.35547S11.1328 14 11 14H2.75c-.13281 0-.26172.05078-.35547.14453S2.25 14.3672 2.25 14.5v7.75c0 .46484.1836.91016.51172 1.23828C3.08984 23.81641 3.53516 24 4 24h7c.13281 0 .26172-.05078.35547-.14453S11.5 23.6328 11.5 23.5ZM13.5 14c-.13281 0-.26172.05078-.35547.14453S13 14.3672 13 14.5v9c0 .13281.05078.26172.14453.35547S13.3672 24 13.5 24H20c.46484 0 .91016-.1836 1.23828-.51172.32813-.32812.51172-.77344.51172-1.23828V14.5c0-.13281-.05078-.26172-.14453-.35547S21.3828 14 21.25 14Zm0 0"
    }, null), createVNode("path", {
      "style": "stroke:none;fill-rule:nonzero;fill:currentColor;fill-opacity:1",
      "d": "M13.04297 6.70703c.1211.1211.27344.20703.4375.2539.16406.04688.33984.05079.50781.00782 1.1836-.28906 4.02735-1.05469 4.89844-1.92188.55469-.55468.86719-1.30859.86719-2.09375 0-.78515-.3125-1.53515-.8711-2.08984-.55468-.55469-1.30468-.86719-2.08984-.86719-.78516 0-1.53906.3125-2.09375.8672-.7539.7578-1.47656 3.07812-1.92188 4.90233-.03515.16797-.03125.33985.01563.50391.04687.16406.13281.3125.25.4375Zm3.07422-4.42969c.08984-.08984.19531-.16406.3125-.21484.11718-.05078.24218-.07813.3711-.08203.125 0 .2539.02344.37109.07031.11718.05078.22656.1211.3164.21094.08985.08984.16016.19922.20703.3164.05078.1172.07422.2461.07032.3711 0 .1289-.02735.2539-.07813.3711-.05078.11718-.125.22265-.21875.3125-.71484.41405-1.48047.72655-2.28125.92968.20313-.80078.51563-1.57031.92969-2.28516ZM11.71875 5.76172c-.4414-1.8164-1.16406-4.14063-1.91797-4.89844C9.2461.3086 8.49218 0 7.70703-.0039c-.78515 0-1.53515.3125-2.08984.8672C5.0625 1.41796 4.75 2.16796 4.75 2.95312c0 .78515.3086 1.53906.86328 2.09375.86719.86718 3.71485 1.6328 4.90235 1.92187.16406.04297.33984.03906.5039-.00781.16797-.04688.3164-.13281.4375-.2539.1211-.125.20703-.27345.25-.44142.04688-.16406.05078-.33593.01172-.5039Zm-4.6875-2.1289c-.08984-.08985-.16016-.19532-.21094-.3125-.04687-.11329-.07031-.23829-.07031-.36329s.02344-.25.07031-.36719c.05078-.11718.1211-.22265.20703-.30859.08985-.08984.19532-.16016.3125-.21094C7.45313 2.02344 7.57813 2 7.70313 2c.2539 0 .5.10156.67968.27734.41407.71485.72657 1.48438.92969 2.28516-.80078-.20313-1.57031-.51563-2.28125-.92969Zm0 0"
    }, null)]);
  },
  props: {
    size: {
...
const Information = defineComponent({
  name: "information",
  setup(props, {
    attrs
  }) {
    ...
    return () => createVNode("svg", mergeProps({
      ...
      "style": "stroke:none;fill-rule:nonzero;fill:currentColor;fill-opacity:1",
      "d": "M10 0C4.47656 0 0 4.47656 0 10s4.47656 10 10 10 10-4.47656 10-10S15.52344 0 10 0Zm.20703 4.16406c.6914 0 1.25.5625 1.25 1.25 0 .6914-.5586 1.25-1.25 1.25-.6875 0-1.25-.5586-1.25-1.25 0-.6875.5625-1.25 1.25-1.25Zm1.8789 11.25H8.75c-.3086.01563-.59766-.13672-.75781-.40234a.84635.84635 0 0 1 0-.85938c.16015-.26172.44922-.41797.75781-.40234h.625c.11719 0 .21094-.09375.21094-.20703v-3.75c0-.11719-.09375-.20703-.21094-.20703H8.75c-.46094 0-.83594-.375-.83594-.83594s.375-.83594.83594-.83594h.83594c.4414 0 .86328.17969 1.17578.49219s.48828.73438.48828 1.17969v3.95312c0 .11719.09375.20703.20703.20703h.6289c.3047-.01172.59766.14063.75391.40625.16016.26563.16016.59375 0 .85547-.15625.26563-.44922.42188-.7539.40625Zm0 0"
    }, null)]);
  },
  props: {
    size: {
...
const NavigationMenu4 = defineComponent({
...
const NavigationMenuVertical = defineComponent({
...
const OrderManagement = defineComponent({
...
const PasswordDesktopLockApproved = defineComponent({
...
const Shipping = defineComponent({
  name: "shipping",
  setup(props, {
    attrs
  }) {
...
const SingleNeutralActionsSetting = defineComponent({
...
const StoreSettings = defineComponent({
  name: "store-settings",
  setup(props, {
    attrs
  }) {
...
const Subtract = defineComponent({
  name: "subtract",
  setup(props, {
    attrs
  }) {
...
const WarehouseCartPackage = defineComponent({
...
const WarningTriangle = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode("svg", mergeProps({
      ...
      "style": "fill:none;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke:currentColor;stroke-opacity:1;stroke-miterlimit:4",
      "d": "M7 5v3m.499 2.999a.5.5 0 1 1-.999.004.5.5 0 0 1 .999-.004Zm0 0",
      "transform": "scale(1.71429)"
    }, null), createVNode("path", {
      "style": "fill:none;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke:currentColor;stroke-opacity:1;stroke-miterlimit:4",
      "d": "M7.891 1.05a1.002 1.002 0 0 0-1.782 0l-5.498 11a.994.994 0 0 0 .04.972c.18.297.502.477.848.479h11.002a.998.998 0 0 0 .847-.479.994.994 0 0 0 .041-.973Zm0 0",
      "transform": "scale(1.71429)"
    }, null)]);
  },
  props: {
